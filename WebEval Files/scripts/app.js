var getUserMedia = navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.mediaDevices.getUserMedia(constraints);
...
var prevQuestion = document.querySelector('.prev');
...
//}
//document.getElementById("question_block").innerHTML = text;
...
if (navigator.mediaDevices.getUserMedia) {
  ...
  var onSuccess = function(stream) {
    ...
    mediaRecorder.onstop = function(e) {
      ...
      if(clipName === null) {
        clipLabel.textContent = 'WebEval un-named recording';
      } else {
